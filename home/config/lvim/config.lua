...
formatters.setup {
  {
    command = "prettier",
    extra_args = { "--print-with", "100", "--single-quote", "--trailing-comma", "all" },
  },
}
...
vim.opt.colorcolumn = vim.api.nvim_eval('join(range(101, 999), ",")')
...
lvim.colorscheme = vim.api.nvim_exec([[ colorscheme ]], true)
